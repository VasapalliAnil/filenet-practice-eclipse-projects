require(
		[ "dojo/_base/lang", "dojo/on", "dojo/dom", "dojo/aspect",
				"pvr/widget/editors/_FormattedDropDownEditor", "dijit/Dialog",
	            "dijit/form/Button",
	            "dojo/dom-construct",
	            "dojo/on" ],
		function(lang, on, dom, aspect, formattedDropDownEditor, Dialog, Button,domConstruct,on) {
			...
			aspect
					.after(
							pvr.widget.editors._DropDownEditor.prototype,
							"postCreate",
							function() {
								debugger;
								...
								if (this.property.controller.id == "MobileNumbers"
										|| this.property.controller.id == "PhoneNumbers") {
									// debugger;
									...
									var copyButton = new Button(
											{
												...
												onClick : function() {
													...
													// label value
													var label = this
															.getParent().domNode.childNodes[1].innerText;
