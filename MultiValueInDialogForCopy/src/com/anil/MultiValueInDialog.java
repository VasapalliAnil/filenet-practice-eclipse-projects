 ...
 * <p>
 */
public class MultiValueInDialog extends Plugin {
	...
	public String getName(Locale locale) {
		return "Show Multi Value in Dialog Box";
	}
	...
	public String getConfigurationDijitClass() {
		return "multiValueInDialogDojo.ConfigurationPane";
	}
