...
public class SearchResponseFilter extends PluginResponseFilter {
	...
	public void filter(String serverType, PluginServiceCallbacks callbacks,
		...
		System.out.println("Inside /p8/search filter ");
		System.out.println("p8 search response :"+jsonResponse);
		JSONResultSetResponse jsonResultSetResponse=(JSONResultSetResponse) jsonResponse;
		System.out.println(" p8 search Column Count :"+jsonResultSetResponse.getColumnCount());
		try{
			for(int i=0;i<jsonResultSetResponse.getColumnCount();i++){
				...
				System.out.println("P8 Search resonse : ColumName :"+columnName);
				if(columnName != null && columnName.equals("CCA_Priority")){
					System.out.println("inside priority ");
					column.put("decorator", "priorityDecorator");
					
					column.put("name","&nbsp;");
					column.put("width", "48px");
				}
			}
		}
		catch(Exception e){
			System.out.println(" P8 Searchc Exception occured :"+e);
		}
