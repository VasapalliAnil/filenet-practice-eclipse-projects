 ...
 * web browser.
 */
public class WorkItemsResponseFilter extends PluginResponseFilter {
	...
	public void filter(String serverType, PluginServiceCallbacks callbacks,
		...
		try {
		      ...
		      JSONArray cells = (JSONArray)columns.get("cells");
		      System.out.println("Cells:" + cells);
		      if (user.equals("p8admin"))
		        for (int i = 0; i < numberOfRows.intValue(); i++) {
		          JSONObject rowitr = (JSONObject)rows.get(i);
		          JSONObject attr = (JSONObject)rowitr.get("attributes");
		          JSONArray tte = (JSONArray)attr.get("COMMN_TotalTimeExpiredDHM");
		          System.out.println("Total time expired fetched");
		          if (!tte.isEmpty()) {
		            tte.clear();
