 ...
 * <p>
 */
public class CCAScriptAdapterPlugin extends Plugin {
	...
	public String getName(Locale locale) {
		return "CCA Script Adapter Plugin";
	}
	...
	public String getScript() {
		return "CCAScriptAdapterPlugin.js";
	}
	...
	public String getDojoModule() {
		return "cCAScriptAdapterPluginDojo";
	}
	...
	public String getCSSFileName() {
		return "CCAScriptAdapterPlugin.css";
	}
	...
	public String getConfigurationDijitClass() {
		return "cCAScriptAdapterPluginDojo.ConfigurationPane";
	}
	...
	public com.ibm.ecm.extension.PluginResponseFilter[] getResponseFilters() {
		return new com.ibm.ecm.extension.PluginResponseFilter[]{ new com.test.cm.cca.SearchResponseFilter(), new com.test.cm.cca.WorkItemsResponseFilter()};
	}
	...
	/**
		...
		public com.ibm.ecm.extension.PluginRequestFilter[] getRequestFilters() {
			//return new com.ibm.ecm.extension.PluginRequestFilter[]{new com.test.cm.cca.CustomIDSetRequestFilter()};
	...
	public com.ibm.ecm.extension.PluginService[] getServices() {
		return new com.ibm.ecm.extension.PluginService[]{new com.test.cm.cca.CustomerWebApplicationService(), new com.test.cm.cca.service.CreateDocumentService()};
	}
